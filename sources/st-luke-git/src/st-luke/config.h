...
static char *font2[] = { 
    "Sarasa Term J:pixelsize=14:antialias=true:autohint=true",
    "Sarasa Term TC:pixelsize=14:antialias=true:autohint=true",
    "Sarasa Term SC:pixelsize=14:antialias=true:autohint=true",
    "Sarasa Term HC:pixelsize=14:antialias=true:autohint=true",
    "Sarasa Term CL:pixelsize=14:antialias=true:autohint=true",
    "Sarasa Term K:pixelsize=14:antialias=true:autohint=true"
};
